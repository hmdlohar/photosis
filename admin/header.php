...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
      <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="index.php">photOsis Admin Panel</a>
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link" href="cliparts.php">
                  
                  Cliparts
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="frames.php">
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a class="nav-link" href="feedback_message.php">
