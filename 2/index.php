 ...
 <header>
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
         ...
         <div class="carousel-item active" style="background-image: url('img/front_photo_1.png')">
            <div class="carousel-caption d-none d-md-block">
              <h3 style="text-shadow:0px 0px 4px black;">Want to edit your Photos?</h3>
              <p style="text-shadow:0px 0px 4px black;">Just drag your photo to our <a href="ieditor.php">iEditor</a> and start editing it.</p>
            </div>
          </div>
          
          <!-- Slide Two - Set the background image for this slide in the line below -->
        <div class="carousel-item" style="background-image: url('img/front_photo_3.png')">
            <div class="carousel-caption d-none d-md-block">
              <h3 style="text-shadow:0px 0px 4px black;">Drag and get started.</h3>
              <p style="text-shadow:0px 0px 4px black;">iEdit provide you facility to edit photos without installing any app on your device.</p>
            </div>
          </div>
	...
	<div class="row" >
		...
		<div class="col-lg-4 mb-4">
          <div class="card h-100">
            <h4 class="card-header">Crop Images</h4>
            <div class="card-body">
              <p class="card-text">Crop  your photos easily without any loading time. </p>
            </div>
            <div class="card-footer">
              <a href="ieditor.php" class="btn btn-primary">Get Started</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            <h4 class="card-header">Resize Images</h4>
            <div class="card-body">
              <p class="card-text">Crop  your photos easily without any loading time. </p>
            </div>
            <div class="card-footer">
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            <h4 class="card-header">Add Text</h4>
            <div class="card-body">
              <p class="card-text">You can add text to your image. </p>
            </div>
            <div class="card-footer">
              <a href="ieditor.php" class="btn btn-primary">Get Started</a>
            </div>
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            <h4 class="card-header">Add Frames</h4>
            <div class="card-body">
              <p class="card-text">You can add interesting frame from our frames gallery where you can find lot of freely available frames. </p>
            </div>
            <div class="card-footer">
              <a href="ieditor.php" class="btn btn-primary">Get Started</a>
            </div>
...
<h2>User's picks</h2>
      ...
      <div class="row">
			...
			foreach ($userPhotos as $key => $value) {
				echo '<div class="col-lg-4 col-sm-6 portfolio-item">
			          <div class="card h-100">
			            ...
			            .$value['id'].'.png" alt="error in loading"></a>
			            <div class="card-body">
			              <h4 class="card-title">
			                <a href="#">'.$value['name'].'</a>
			              </h4>
		...
		?>        
		<!-- require a div to open the photos individually -->
      </div>
      <!-- /.row -->
